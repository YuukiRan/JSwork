...
let shop = {
    ...
    'addListeners': function () {
        ...
        */
        for (let i = 0; i < this.addToCartButtons.length; i++) {
            ...
            //     this.updateCart(b.getAttribute('productId'))
            // })
        }
        /*
            3
        ...
        */
        for (let i = 0; i < this.allProducts.length; i++) {
            if (this.allProducts[i].id == p_id) {
                ...
                */
                // document.body.setAttribute("productId",);
                ...
                */
                let items = JSON.stringify(this.cart.items);
                setCookie(this.cookieName, items);
    ...
    'submit': function () {
        ...
        let data = {
            ...
            // 'token': '867383a127721c8e0d1148cd5daa6c09ba0b6f7d516f26713e82aefb0b9309f8'
        };
